...
export default function HakkimizdaEditor() {
  ...
  useEffect(() => { fetch("/api/vippanel/sayfalar/hakkimizda").then(r => r.json()).then(setData); }, []);
  ...
  async function handleSave() {
    ...
    await fetch("/api/vippanel/sayfalar/hakkimizda", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
