...
export default function FiyatlarEditor() {
  ...
  useEffect(() => {
    fetch("/api/vippanel/sayfalar/fiyatlar").then(r => r.json()).then(setData);
  }, []);
  ...
  async function handleSave() {
    ...
    await fetch("/api/vippanel/sayfalar/fiyatlar", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
