...
const NAV_ITEMS = [
  { href: "/vippanel", label: "Dashboard", icon: "⬛" },
  { href: "/vippanel/header", label: "Header", icon: "🔝" },
  { href: "/vippanel/hero", label: "Hero Bölümü", icon: "🏠" },
  { href: "/vippanel/footer", label: "Footer", icon: "⬇️" },
  { href: "/vippanel/iletisim", label: "İletişim & Site", icon: "⚙️" },
  { href: "/vippanel/kodlar", label: "Kod & Scriptler", icon: "💻" },
  { href: "/vippanel/sayfalar", label: "Sayfa Yönetimi", icon: "📄" },
  { href: "/vippanel/blog", label: "Blog Yazıları", icon: "📝" },
  { href: "/vippanel/toplu-yayin", label: "Toplu Yayın", icon: "📦" },
  { href: "/vippanel/marka-tamirler", label: "Marka Tamir Sayfaları", icon: "📱" },
  { href: "/vippanel/zamanlama", label: "Zamanlama", icon: "🗓️" },
  { href: "/vippanel/yorumlar", label: "Yorumlar", icon: "⭐" },
  { href: "/vippanel/sss", label: "SSS", icon: "❓" },
  { href: "/vippanel/navigasyon", label: "Navigasyon", icon: "🔗" },
  { href: "/vippanel/videolar", label: "Videolar", icon: "🎬" },
];
...
export function AdminSidebar() {
  ...
  // Giriş ekranında menü görünmemeli (oturumsuz ziyaretçiye yönetim
  // panelinin yapısını ifşa etmemek için).
  if (pathname === "/vippanel/giris") return null;

  async function handleLogout() {
    setLoggingOut(true);
    await fetch("/api/vippanel/auth", { method: "DELETE" });
    router.push("/vippanel/giris");
  }

  function isActive(href: string) {
    if (href === "/vippanel") return pathname === "/vippanel";
