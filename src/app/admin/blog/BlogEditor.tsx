...
export function BlogEditor({ mode, initialData }: Props) {
  ...
  async function handleSave() {
    ...
    const url = mode === "edit" ? `/api/admin/blog/${data.slug}` : "/api/admin/blog";
  ...
  return (
    <div className="p-6 md:p-8 pt-16 md:pt-8">
      ...
      <div className="flex items-center gap-4 mb-6">
        <button onClick={() => router.push("/admin/blog")} className="text-zinc-400 hover:text-zinc-600 transition-colors">
          ← Geri
        </button>
