...
export default function AdminDashboard() {
  ...
  const stats = [
    ...
    { label: "Marka Tamir Sayfası", value: totalRepairPages,      href: "/admin/marka-tamirler", color: "#ff351b", icon: "📱" },
  ];
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-zinc-100">
          ...
          <div className="space-y-2">
            {[
              ...
              { href: "/admin/marka-tamirler",    label: "Marka Tamir Sayfaları",        icon: "📱" },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-6 shadow-sm border border-zinc-100">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/admin/marka-tamirler" className="text-xs font-bold" style={{ color: "#1A3A6B" }}>Yönet →</Link>
          </div>
