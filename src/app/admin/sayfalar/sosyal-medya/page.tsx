...
export default function SosyalMedyaEditor() {
  ...
  useEffect(() => { fetch("/api/admin/sayfalar/sosyal-medya").then(r => r.json()).then(setData); }, []);
  ...
  async function handleSave() {
    ...
    await fetch("/api/admin/sayfalar/sosyal-medya", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
