...
export default function TamirEgitimiEditor() {
  ...
  useEffect(() => { fetch("/api/admin/sayfalar/tamir-egitimi").then(r => r.json()).then(setData); }, []);
  ...
  async function handleSave() {
    ...
    await fetch("/api/admin/sayfalar/tamir-egitimi", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(data) });
